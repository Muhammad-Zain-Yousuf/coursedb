    ...
    return (
        <Container className='bg-dark mt-5 mb-5'>
            <Row className="d-flex align-items-center">
                <Col sm={12} md={6} lg={6}>
                    <img src={`../${course.picture}`} alt="Course" style={{"width":"500px", "height": "350px", "padding": "20px"}} />
                </Col>

                <Col sm={12} md={6} lg={6}>
                    <p className='mb-5'>
                        <span className='course-details'>Course Name:</span>
                        {course.title}
                    </p>
                    <p className='mb-5'>
                        <span className='course-details'>Course Description:</span>
                        {course.desc}
                    </p>
